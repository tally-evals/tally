...
Hallucination:
 is an LLM-as-a-judge metric that checks whether the answer contains unsupported or made-up information based on the input and context. it returns 1.0 if hallucination is detected and 0.0 otherwise. Example: 

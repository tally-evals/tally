        ...
        tabs: [
          {
            ...
            urls: new Set([
              ...
              '/docs/tally/reports',
              '/docs/tally/reference',
              '/docs/tally/reference/index',
              '/docs/tally/reference/metric',
              '/docs/tally/reference/builtin-metrics',
              '/docs/tally/reference/normalization',
              '/docs/tally/reference/scorers',
              '/docs/tally/reference/aggregators',
              '/docs/tally/reference/evals',
              '/docs/tally/reference/create-tally',
              '/docs/tally/reference/data',
              '/docs/tally/reference/utils',
            ]),

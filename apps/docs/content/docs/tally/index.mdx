...
- **Measure vs. Policy**: Decouple *what* you measure from *how* you judge it. A metric (e.g., Answer Relevance) remains constant across different scenarios—only the **Verdict Policy** changes to reflect the rigor needed for a "Golden Dataset" vs. a "Smoke Test."

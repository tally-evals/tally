...
Single-turn metrics can include custom aggregators to compute summary statistics across all targets. While Tally provides [default aggregators](/docs/tally/metrics) based on value type, you can define custom ones—including custom percentiles.
...
See the full reference: [Aggregators](/docs/tally/reference/aggregators).

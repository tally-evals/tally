...
| [**Aggregator**](/docs/tally/aggregators) | **Statistician** | Summarizes individual results into dataset-level statistics (e.g., Mean, Pass Rate). | <CodePopover title="Aggregator (core)" tsDef={aggregatorTsDef} example={aggregatorExample} /> |

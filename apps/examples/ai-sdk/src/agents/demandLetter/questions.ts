...
// Trimmed set: Q1-21 (continuous). Q10/Q21 converted to open text.
export const QUESTIONS: QuestionConfig[] = [
	...
	},
	{
		...
		type: 'open',
		validation: { type: 'text', required: true, minLength: 5 },
		contextDependencies: [1, 2, 3, 4, 5, 6, 7, 8, 9, 14],
	},
	{
		id: 'q16',
		order: 16,
	...
	},
	{
		...
		contextDependencies: [2, 3, 4, 5, 6, 7, 8, 9, 16],
		showWhenChoiceEquals: { dependsOnOrder: 16, values: ['Yes'] },
	},
	{
		id: 'q18',
		order: 18,
	...
	},
	{
		...
		type: 'open',
		validation: { type: 'text', required: true, minLength: 2 },
		contextDependencies: [1, 2, 3, 4, 5, 6, 7, 8, 9, 15],
	},
	{
		id: 'q20',
		order: 20,

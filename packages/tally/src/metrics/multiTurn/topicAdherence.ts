...
2. Relevance of the assistant's responses to the expected topics${allowTopicTransitions ? '\n3. Naturalness of topic transitions (if applicable)' : ''}${strictMode ? '\n4. Strict adherence to topics without any deviations' : ''}`,
			...
			examples: [
				{
					score: 5,
					reasoning: 'Assistant perfectly adheres to all specified topics throughout the conversation with consistent focus',
				},
				{
					score: 4,
					reasoning: 'Assistant mostly adheres to topics with minor, acceptable deviations or brief off-topic moments',
				},
				{
					score: 3,
					reasoning: 'Assistant partially adheres to topics but has noticeable deviations or loses focus',
				},
				{
					score: 2,
					reasoning: 'Assistant occasionally adheres to topics but frequently deviates or gets sidetracked',
				},
				{
					score: 1,
					reasoning: 'Assistant rarely adheres to the specified topics and frequently goes off-topic',
				},
				{
					score: 0,
					reasoning: 'Assistant does not adhere to the specified topics at all and consistently discusses unrelated subjects',
				},
			],
		},
		normalization: {

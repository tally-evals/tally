...
>(options: AnswerRelevanceOptions): SingleTurnMetricDef<number, TContainer> {
  const { provider, partialWeight = 0.3, aggregators } = options;
      ...
      examples: [
        {
          score: 5,
          reasoning:
            'Response directly and completely answers the query with focused, relevant information',
        },
        {
          score: 4,
          reasoning:
        ...
        },
        {
          score: 3,
          reasoning:
            'Response partially answers the query, mixing relevant and unrelated information',
        },
        {
          score: 2,
          reasoning:

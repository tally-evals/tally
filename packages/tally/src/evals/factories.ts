...
export function defineSingleTurnEval<
	...
	// biome-ignore lint/suspicious/noExplicitAny: <explanation>
		TMetricValue extends MetricScalar = TMetric extends SingleTurnMetricDef<infer T, any> ? T : MetricScalar
>(args: {
	name: string;
	description?: string;
	metric: TMetric;
...
export function defineMultiTurnEval<
	...
	// Infer raw value type from the provided metric, mirroring defineInput pattern
	// biome-ignore lint/suspicious/noExplicitAny: <explanation>
		TMetricValue extends MetricScalar = TMetric extends MultiTurnMetricDef<infer T, any> ? T : MetricScalar
>(args: {
	name: string;
	description?: string;
	metric: TMetric;
